...
// UPDATES SINCE 1.5:
//  - CHANGED THE STUPID SWITCH CASE TO ELSE IF
//  - ATTEMPT TO FIX THE ERROR WHERE MISTY DOES NOT RESET HERSELF
//  - ATTEMPT TO FIX THE ERROR WHERE MISTY SPAM DETECTS FACES
...
function _FaceRec(data) {
    if (isRunning == false) {
        ...
        if (random == 0) {
            ...
            misty.Debug("soren u are an idiot");
...
// The main function, basically self explanatory.
function main() {
